...
Public Class SalaryDesign
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RiyoTop_Employee_Managemnet.SalaryDesign.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalaryDesign
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalaryDesign = New SalaryDesign()
        rpt.Site = Me.Site
        Return rpt
    End Function
